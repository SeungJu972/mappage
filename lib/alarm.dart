...
import 'package:mappage/alarmSetting.dart';
import '/main.dart';
import 'alaramData.dart';
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MyApp(), // 초기화면으로 돌아갑니다.
                          ),
                        );
                      },
                    ),
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => alarmSetting(), // 초기화면으로 돌아갑니다.
                            ),
                          );
                        },
                        child: Text(
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => alarmData(), // 초기화면으로 돌아갑니다.
                            ),
                          );
                        },
                        child: Text(
